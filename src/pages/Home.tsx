...
const viralCards = [
  {
    ...
    tone: "bg-[#1148ff] text-[#f5f1e8] rotate-[-2deg]",
  },
  {
    kind: "manifesto",
    text: "Ideia para ação local?",
    support: "Ative seu território na Semana da Compostagem.",
    tone: "bg-[#f5f1e8] text-black rotate-[1deg]",
  },
  {
    kind: "convocação",
    text: "Quer somar com a rede?",
    support: "Entre em órbita como Compostonauta.",
    tone: "bg-[#2f8f35] text-[#f5f1e8] rotate-[-1deg]",
  },
];
    ...
    <div className="bg-[#050505] text-[#f5f1e8] min-h-[100dvh] selection:bg-[#ffb000] selection:text-black font-sans relative overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-5 md:px-8 py-6 flex items-center justify-between mix-blend-difference">
        <a href="#" className="flex items-center gap-4 group">
          <div className="w-8 h-8 rounded-full bg-[#ffb000] group-hover:scale-110 transition-transform duration-500 ease-out"></div>
        ...
        <nav className="hidden md:flex gap-10 font-mono text-xs tracking-[0.2em] text-white/50">
          ...
          <a href="#participar" className="hover:text-[#ffb000] transition-colors duration-300">PARTICIPAR</a>
          <a href="#dez" className="hover:text-[#ffb000] transition-colors duration-300">10 ANOS</a>
          <a href="#participar" className="bg-[#ffb000] text-black px-4 py-2 -mt-2 font-bold hover:bg-white transition-colors">WHATSAPP</a>
        </nav>
      </header>
      ...
      <main>
        ...
        <section id="triade" className="bg-[#f5f1e8] text-[#050505] p-3 md:p-6">
              ...
              <div className="lg:w-2/3 flex flex-col gap-8">
                ...
                >
                  ...
                  <p className="text-white/60 font-sans text-lg md:text-xl leading-relaxed max-w-2xl relative z-10">
                    Devolver à terra o que é da terra. A compostagem transforma resíduos em vida e reconecta cidade, alimento e cuidado com o solo.
                  </p>
                </motion.div>
        ...
        <section className="relative bg-[#f5f1e8] text-black px-5 md:px-12 py-24 md:py-32 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-black/45 mb-6">linguagem que aduba</p>
              <h2 className="font-anton uppercase text-[4rem] md:text-[7.5rem] lg:text-[9rem] leading-[0.76] tracking-tight max-w-6xl">
            ...
            <div className="mt-16 md:mt-20 grid md:grid-cols-3 gap-7 md:gap-8">
              {viralCards.map((card, index) => (
                <motion.div
                  ...
                  viewport={{ once: true, margin: "-80px" }}
                  transition={{ duration: 0.55, delay: index * 0.08 }}
                  className={`${card.tone} border-[4px] border-black min-h-[150px] md:min-h-[170px] p-7 md:p-9 shadow-[8px_8px_0_#000] flex flex-col justify-between hover:rotate-0 hover:-translate-y-2 transition-transform duration-500`}
                >
                  <div>
                    <p className={`leading-tight ${index === 1 ? "font-anton uppercase text-3xl md:text-4xl" : "font-caveat text-3xl md:text-4xl"}`}>
                      {card.text}
                    </p>
                    <p className="mt-5 font-space text-base md:text-lg font-bold leading-snug opacity-75">
                      {card.support}
                    </p>
                  </div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.25em] opacity-60 mt-8">{card.kind}</span>
                </motion.div>
              ))}
            </div>
        ...
        <section id="rede" className="py-32 md:py-48 bg-[#ffb000] text-black relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-5 relative z-10">
            <div className="text-center mb-24">
              <h2 className="font-caveat text-5xl md:text-7xl text-black mb-6 transform -rotate-2">pessoas & fungos em campanha</h2>
              ...
              <p className="text-xl md:text-2xl font-sans font-medium text-black/70 max-w-3xl mx-auto leading-relaxed mt-10">
                A campanha de 10 anos não é uma vitrine. É uma convocação para ativar territórios durante a Semana da Compostagem 2026 e preparar o Dia do Compostonauta.
              </p>
            </div>
        ...
        <section id="chamada" className="relative bg-[#0a0a0a] text-[#f5f1e8] px-5 md:px-12 py-28 md:py-40 overflow-hidden grain">
          ...
          <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-7">
              <p className="font-mono text-xs uppercase tracking-[0.3em] text-[#ffb000] mb-7">chamada aberta do movimento</p>
              <h2 className="font-anton uppercase text-[4.5rem] md:text-[8rem] leading-[0.78] tracking-tight">
                Quer ativar<br />
                seu território?
              </h2>
            ...
            <div id="participar" className="lg:col-span-5 bg-[#f5f1e8] text-black border-[4px] border-black p-7 md:p-9 shadow-[10px_10px_0_#ffb000] rotate-[-1deg]">
              <p className="font-caveat text-3xl md:text-4xl mb-4">sinalize interesse</p>
              <h3 className="font-space uppercase font-bold text-3xl md:text-4xl leading-none mb-8">Entrar na órbita Compostonauta</h3>
              <p className="mb-6 text-black/65 leading-relaxed">
                Deixe seu contato para receber o convite da chamada aberta, os próximos passos da campanha e formas de participar da Semana da Compostagem 2026.
              </p>
              <div className="space-y-4">
                <input aria-label="Nome" placeholder="Nome / coletivo" className="w-full border-[3px] border-black bg-white px-4 py-4 font-mono text-sm outline-none focus:bg-[#ffb000]/20" />
                <input aria-label="Cidade" placeholder="Cidade / território" className="w-full border-[3px] border-black bg-white px-4 py-4 font-mono text-sm outline-none focus:bg-[#ffb000]/20" />
                <input aria-label="Contato" placeholder="E-mail ou WhatsApp" className="w-full border-[3px] border-black bg-white px-4 py-4 font-mono text-sm outline-none focus:bg-[#ffb000]/20" />
                <select aria-label="Forma de participação" className="w-full border-[3px] border-black bg-white px-4 py-4 font-mono text-sm outline-none focus:bg-[#ffb000]/20">
                  <option>Quero organizar uma ação local</option>
                  <option>Quero apoiar a campanha</option>
                  <option>Quero ser parceiro</option>
                  <option>Quero receber convite da chamada aberta</option>
                </select>
              </div>
        ...
        <section id="dez" className="py-32 md:py-52 bg-[#050505] relative grain overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-5 relative z-10">
            ...
            >
              2016 — 2026<br />
              <span className="text-[#9caf88]">Da década aos próximos chamados.</span>
            </motion.h2>
            
            <p className="font-sans text-lg md:text-xl text-white/60 leading-relaxed max-w-3xl mx-auto font-light text-center">
              A próxima etapa já começou: mobilizar a Semana da Compostagem e preparar o novo ciclo Compostonauta.
            </p>
                ...
                <div className="space-y-9">
                  {timelineMilestones.map((milestone, index) => (
                    ...
                    >
                      ...
                      <div className="font-space text-xs uppercase tracking-[0.2em] text-[#ffb000] mt-1">{milestone.title}</div>
                      <p className="mt-3 text-sm leading-relaxed text-white/55">{milestone.copy}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
            ...
            <div className="mt-16 flex flex-col sm:flex-row justify-center gap-4">
              <a href="#participar" className="bg-[#ffb000] text-black px-8 py-4 font-space uppercase tracking-widest text-xs font-bold border-[3px] border-black hover:bg-white transition-colors">
                Entrar no grupo
              </a>
